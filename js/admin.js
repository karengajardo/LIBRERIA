...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // FUNCIÓN CENTRALIZADA PARA GUARDAR EN SESSIONSTORAGE
    function guardarLibrosEnSessionStorage() {
        localStorage.setItem('inventarioLibreria', JSON.stringify(catalogoLibros));
    }
    ...
    if (formAdmin) {
        formAdmin.addEventListener("submit", (e) => {
            ...
            const nuevoLibro = {
                ...
                novedad: document.getElementById("admin-nuevo").checked,
                descripcion: "Libro registrado en el catálogo."
            };

            catalogoLibros.push(nuevoLibro);

            // Guardar usando sessionStorage con la clave correcta
            guardarLibrosEnSessionStorage();
