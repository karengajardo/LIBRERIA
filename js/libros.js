...
// ==========================================
// 6. LÓGICA DEL CARRITO (Guardar y Actualizar)
// ==========================================
...
function agregarAlCarrito(titulo, precio) {
    ...
    alert(`¡"${titulo}" se agregó a tu carrito correctamente!`);
}
...
// ==========================================
// 7. PÁGINA DEL CARRITO (Dibujar y Eliminar)
// ==========================================
        ...
        carrito.forEach((libro, index) => {
            const itemHTML = `
                <div class="item-carrito">
                    <div>
                        <h3 style="margin: 0;">${libro.titulo}</h3>
                        <p style="margin: 0; color: #555;">${libro.precio}</p>
                    </div>
